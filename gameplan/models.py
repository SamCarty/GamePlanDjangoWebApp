...
class Game(models.Model):
    ...
    game_engines = models.ManyToManyField(GameEngine, db_table='game_game_engine', null=True)
    game_modes = models.ManyToManyField(GameMode, db_table='game_game_mode', null=True)
    hypes = models.IntegerField(null=True)
    involved_companies = models.ManyToManyField(InvolvedCompany, db_table='game_involved_company', null=True)
    keywords = models.CharField(max_length=5000, null=True)
    platforms = models.ManyToManyField(Platform, db_table='game_platform', null=True)
    player_perspectives = models.ManyToManyField(PlayerPerspective, db_table='game_player_perspectives', null=True)
    popularity = models.FloatField(null=True)
    release_dates = models.ManyToManyField(ReleaseDate, db_table='game_release_dates', null=True)
    screenshots = models.ManyToManyField(Screenshot, db_table='game_screenshots', null=True)
    themes = models.ManyToManyField(Theme, db_table='game_theme', null=True)
    total_rating = models.FloatField(null=True)
    total_rating_count = models.IntegerField(null=True)
    url = models.URLField(max_length=200, null=True)
    videos = models.ManyToManyField(Video, db_table='game_video', null=True)
    websites = models.ManyToManyField(Website, db_table='game_website', null=True)
