"""gameplan_project URL Configuration
...
urlpatterns = [
    ...
    path('search/', include('search.urls')),  # search and autocomplete
    path('accounts/', include('accounts.urls')),  # account management and wishlish
